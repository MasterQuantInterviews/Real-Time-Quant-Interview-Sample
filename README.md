...
- 这本资料和市面上其他quant 题库例如红皮书绿皮书有什么区别: 这个更多是一个大纲而不是一个题库。 以红绿皮书为代表的quant 题库/书在市面上以及流传很久了，以至于现在任何人面试之前都要刷这几本书。其次这些题库基本都是7，8年前写出来的， 很多题已经过时。 很多同学使用红绿皮书的都反应没有一个clear direction。 这些题库往往有上百道题，对于面试经验较少的同学来说很难去找到侧重点。
