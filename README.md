...
这本资料分成三大部分：1. Probability & Statistics, 2. Dynamic Programming, 3. Other Maths and Machine Learning。 每一章只需要一个小时左右就能看完，但效率及结果等同于几十甚至上百个面试经验。看完大家会知道其实大多数的面试题不会很难，大多是可能一两句话就可以给出答案。毕竟平均一场面试只有一个小时左右，每个面试评价3，4道题，所以面试官不可能问一些特别复杂的题类似数学推导等等。这也就是说我们只要能够找到面试官问的题背后所需要的知识点并阐述，即使最后没有百分百答对也能获得所谓的"过程分"。
